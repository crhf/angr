...
def test_empty_stack():
    ...
    unittest.TestCase().assertEqual(cs.current_function_address, 0x402000)
    unittest.TestCase().assertEqual(cs.current_stack_pointer, 0xfffffe80)

    # Return to 0x40100c
    cs = cs.ret(0x40100c)

    unittest.TestCase().assertEqual(cs.current_function_address, 0x401000)
    unittest.TestCase().assertEqual(cs.current_stack_pointer, 0xffffff00)

    cs = cs.ret(0x400004)

    unittest.TestCase().assertEqual(cs.current_function_address, 0x300000)
    unittest.TestCase().assertEqual(cs.current_stack_pointer, 0xfffffff0)
    ...
    unittest.TestCase().assertEqual(cs.current_function_address, 0)
    unittest.TestCase().assertEqual(cs.current_stack_pointer, 0)
