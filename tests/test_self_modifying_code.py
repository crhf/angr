...
def test_self_modifying_code():
    ...
    unittest.TestCase().assertTrue(claripy.is_true(retval == 65))
    ...
    unittest.TestCase().assertTrue(pg.one_deadended.history.bbl_addrs.hardcopy == pgu.one_deadended.history.bbl_addrs.hardcopy)
