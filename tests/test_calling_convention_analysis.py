...
def run_fauxware(arch, function_and_cc_list):
    ...
    for func_name, expected_cc in function_and_cc_list:
        ...
        unittest.TestCase().assertEqual(cc, expected_cc)
...
def check_args(func_name, args, expected_arg_strs):
    ...
    unittest.TestCase().assertEqual(len(args), len(expected_arg_strs), msg="Wrong number of arguments for function %s. "
                                                                   "Got %d, expect %d." % (
    ...
    for idx, (arg, expected_arg_str) in enumerate(zip(args, expected_arg_strs)):
        ...
        unittest.TestCase().assertTrue(r, msg="Incorrect argument %d for function %s. Got %s, expect %s." % (
