...
def test_find_exits():
    ...
    unittest.TestCase().assertEqual(all_exits, {
        18: [ 0x400594 ],
...
def test_control_flow_slicing():
    ...
    unittest.TestCase().assertEqual(anno_cfg.get_whitelisted_statements(0x40057c), None)
    unittest.TestCase().assertEqual(anno_cfg.get_whitelisted_statements(0x400594), None)
    unittest.TestCase().assertEqual(anno_cfg.get_whitelisted_statements(0x4005a4), [ ])
...
def test_last_branching_statement():
    ...
    unittest.TestCase().assertEqual(stmt_idx, 22)
    unittest.TestCase().assertEqual(tmp, 27)
