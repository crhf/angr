...
def test_ccall():
    ...
    unittest.TestCase().assertTrue(s.solver.is_true(cf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(pf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(af == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(zf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(sf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(of == 0))

    l.debug("(32-bit) (-1) + (-2)...")
    arg_l = s.solver.BVV(-1, 32)
    arg_r = s.solver.BVV(-1, 32)
    cf, pf, af, zf, sf, of = s_ccall.pc_actions_ADD(s, 32, arg_l, arg_r, 0, platform='AMD64')
    unittest.TestCase().assertTrue(s.solver.is_true(cf == 1))
    unittest.TestCase().assertTrue(s.solver.is_true(pf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(af == 1))
    unittest.TestCase().assertTrue(s.solver.is_true(zf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(sf == 1))
    unittest.TestCase().assertTrue(s.solver.is_true(of == 0))
    ...
    unittest.TestCase().assertTrue(s.solver.is_true(cf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(pf == 1))
    unittest.TestCase().assertTrue(s.solver.is_true(af == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(zf == 1))
    unittest.TestCase().assertTrue(s.solver.is_true(sf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(of == 0))
    ...
    unittest.TestCase().assertTrue(s.solver.is_true(zf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(sf == 0))
    unittest.TestCase().assertTrue(s.solver.is_true(of == 1))
...
def test_aarch64_32bit_ccalls():
    ...
    unittest.TestCase().assertTrue(s.satisfiable(extra_constraints=(flag_z == 0,)))
    unittest.TestCase().assertTrue(s.satisfiable(extra_constraints=(flag_z == 1,)))
    # What VEX does
...
def test_some_vector_ops():
    ...
    unittest.TestCase().assertTrue(s.solver.is_true(calc_result == correct_result))
...
def test_store_simplification():
    ...
    unittest.TestCase().assertTrue(claripy.backends.z3.is_true(exit_state.regs.ebp == state.regs.esp - 4))
