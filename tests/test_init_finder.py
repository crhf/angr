...
def test_p2im_drone():
    ...
    # h12c1.Instance
    unittest.TestCase().assertEqual(state.solver.eval_one(overlay.load(0x20001500, 4, endness='Iend_LE')), 0x40005400)
    # hi2c1.Init.AddressingMode
    unittest.TestCase().assertEqual(state.solver.eval_one(overlay.load(0x20001500+4+0xc, 4, endness='Iend_LE')), 0x4000)
    # h12c1.Init.NoStretchMode
    unittest.TestCase().assertEqual(state.solver.eval_one(overlay.load(0x20001500+4+0x1c, 4, endness='Iend_LE')), 0)
