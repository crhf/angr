...
def test_strncpy():
    ...
    unittest.TestCase().assertEqual(result, b'why hello there\x00')
...
def test_strncpy_size():
    ...
    unittest.TestCase().assertEqual(result, b'just testing things\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
...
def test_strncpy_verify_null():
    ...
    s = explorer.found[0]
    result = s.solver.eval(s.memory.load(s.regs.rax, 40), cast_to=bytes)
    unittest.TestCase().assertEqual(result, b'just testing things\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00AAAAAA\x00')
...
def test_strstr_and_strncpy():
    ...
    unittest.TestCase().assertEqual(result, b'hi th hi there\x00')
...
def test_strstr():
    ...
    unittest.TestCase().assertEqual(result, b'hi there\x00')
