...
def test_memmove():
    ...
    unittest.TestCase().assertEqual(result, b'very useful.\x00')
...
def test_memcpy():
    ...
    unittest.TestCase().assertEqual(result, b"let's test memcpy!\x00")
...
def test_memset():
    ...
    unittest.TestCase().assertEqual(result, b'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB\x00')
